export default {
    ...
    public: {
        ...
        text: "iKnows is a knowledge-centric, decentralised application platform built through a Q&A social approach." +
    ...
    timeline: {
        new: "Latest Progress",
        add: "Add Timeline",
        no: "No Relevant Timeline Content",
        time: "Time Of Events",
        timePlaceholder: "Please enter time of events",
        expand: "Expand All Progress",
        fold: "Fold All Progress",
